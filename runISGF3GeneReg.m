...
load([dir_data,'/Beta_Pri_C1.mat']); % Added .mat files
load([dir_data,'/Beta_Pri_C2.mat']); % Added .mat files
load([dir_data,'/Beta_Pri_Lambda_C1.mat']); % Added .mat files
load([dir_data,'/Beta_Pri_Lambda_C2.mat']); % Added .mat files
...
% common gene cluster
params=[0.00150000000000000,9.93043449352649,0.681529634920911,0.619946456739947]; % Changed params and GeneTime
